...
public class DockerService {
    ...
    public void removeImage(String imageName) {
        ...
        try {
            System.out.println("🗑️ Removing image: " + imageName);
    ...
    public void killContainer(String containerName) {
        ...
        try {
            ...
            Process p = pb.start();
            p.waitFor();
            System.out.println("☠️ Container killed: " + containerName);
        } catch (Exception e) {
